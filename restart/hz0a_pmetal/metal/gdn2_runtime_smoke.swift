...
var dimensions = [batch, steps, heads, values, keys]
...
let result = ["output": Array(UnsafeBufferPointer(start: outputValues, count: output.count)), "final_state": Array(UnsafeBufferPointer(start: finalValues, count: final.count))] as [String: Any]
