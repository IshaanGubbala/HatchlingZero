...
- Overall phase: **H0, H1, and H2 done; T0 and T1 done.** H2 (streaming/chunked equivalence) built and passing on the Torch oracle; T0/T1 (ternary design + sandbox) done for the Torch side (RTX 3060/Windows).
