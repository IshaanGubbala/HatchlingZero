...
Logic (arithmetic, conditional-rule reasoning) and now Computer
Science (program execution), a simplified Teach->Quiz->Apply slice of
section 8.3's full 8-step pipeline (Teach->Demonstrate->Recall->
Reason->Apply->Experiment->Correct->Generalize) -- the full pipeline
is real future work, not implemented here yet."""
